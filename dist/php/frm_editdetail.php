...
$sql = "SELECT * FROM receive_detail rd , package p
        WHERE  p.pa_id = rd.pa_id AND p.pa_id = '$pa_id' ";
                    ...
                    <table class="table table-bordered" align="center" style="width: 100%; height: 100%;">
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <form action="editdetail.php" method="post" style="margin-top: 10px; margin-bottom: 10px;">
                                    <input name="pa_id" type="hidden" id="pa_id" value="<?php echo "$rs[pa_id]";?>" >
                                    <input name="r_id" type="hidden" id="r_id" value="<?php echo "$rs[r_id]";?>" >
                                    ...
                                    <table >
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" id="basic-addon1">Name Sender</span>
                                                    </div>
                                                    <input name="pa_name" id="pa_name" type="text" class="form-control"
                                            ...
                                            <td colspan="2">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select class="custom-select" name="r_id" id="r_id">
                                                            <?php
                                                            $sql2 = "SELECT * from receive ";
                                                            $result2 = mysql_query($sql2,$conn);
                                                            while ($rs2=mysql_fetch_array($result2)){
                                                                echo "<option value = \"$rs2[r_id]\" ";
                                                                if ("$rs[r_id]"=="$rs2[r_id]") {echo'selected';}
                                                                echo ">$rs2[r_name]";
                                                                echo "</option>\n";
                                                            }
                                                            ?>
