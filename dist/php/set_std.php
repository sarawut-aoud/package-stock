...
include 'check.php';
    ...
    $sql = "SELECT * FROM student WHERE s_card = '$valid_uname'";
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <div style="width: 80%; text-align: right; margin-top: 10px;">
                                    <a class="btn btn-warning" href="index_student.php" >
                                        <i class="fas fa-backspace"></i> Back
                                    </a>
                                    <h1></h1>
                                </div>
                                <form action="setstd.php" method="post" enctype="multipart/form-data" style="margin-top: 10px; margin-bottom: 10px;">
                                    <input hidden="s_id" name="s_id" value="<?php echo "$rs[s_id];"?>">
                                    <input hidden="s_pic" name="s_pic" value="<?php echo "$rs[s_pic];"?>">
                                            ...
                                            <td colspan="2">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input name="s_name" id="s_name" type="text" class="form-control"
                                                           placeholder="Student name"  aria-describedby="basic-addon1"
                                                           value="<?php echo "$rs[s_name]";?>">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input name="s_tel" id="s_tel" type="text" class="form-control"
                                                           placeholder="Telophone"  aria-describedby="basic-addon1"
                                                           value="<?php echo "$rs[s_tel]";?>">
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td colspan="2" >
                                                ...
                                                if("$rs[s_pic]" !=""){
                                                    ...
                                                    <div style="text-align: center">
                                                        <img   src="<?php echo"picture/$rs[s_pic]";?>" width="50%"  height="10%">
                                                    </div>
                                                    <?php
                                                }
                                                ?>
                    ...
                    <td colspan="2">
                        <div class="input-group mb-3">
                            ...
                            <input name="s_card" id="s_card" type="text" class="form-control"
                                   disabled value="<?php echo "$rs[s_card]"?>" placeholder="ID Card"  aria-describedby="basic-addon1">
                        </div>
                    </td>
                </tr>
                <tr>
