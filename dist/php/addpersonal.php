...
if($p_name && $p_tel){
    ...
    if($total == 0){
        if($fileupload != ""){
            ...
            $sql = "INSERT INTO personal (p_name,p_tel,fac_id,p_pic) VALUES ('$p_name','$p_tel','$fac_id','$fileupload_name')";
        }else{
            $sql = "INSERT INTO personal (p_name,p_tel,fac_id) VALUES ('$p_name','$p_tel','$fac_id')";
        }
