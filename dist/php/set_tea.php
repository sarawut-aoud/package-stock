...
$sql = "SELECT * FROM teacher WHERE t_card = '$valid_uname'";
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <div style="width: 80%; text-align: right; margin-top: 10px;">
                                    <a class="btn btn-warning" href="index_teacher.php" >
                                        <i class="fas fa-backspace"></i> Back
                                    </a>
                                    <h1></h1>
                                </div>
                                <form action="settea.php" method="post" enctype="multipart/form-data" style="margin-top: 10px; margin-bottom: 10px;">
                    ...
                    <td colspan="2">
                        <div class="input-group mb-3">
                            ...
                            <input name="t_card" id="t_card" type="text" class="form-control"
                                   disabled value="<?php echo "$rs[t_card]"?>" placeholder="ID Card"  aria-describedby="basic-addon1">
                        </div>
                    </td>
                </tr>
                <tr>
