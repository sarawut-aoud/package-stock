...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Manage Receive Detail</h1>
            ...
            <!--<div class="card mb-4">
                <div class="card-header ">
                    <nav class="navbar navbar-light bg-light">
                        <a class="avbar-brand">
                            <i class="fas fa-table mr-1"></i> DataTable Faculty </a>
                        <div style=" width: 80%;height:10%;text-align: right">
                            <a  class="btn btn-success" href="frm_addfac.php"  >
                    ...
                    <td align="center"  >
                        ...
                        <div align="center" style="width: 80%">
                            <table class="table table-hover" id="example" width="100%"  style="margin-top: 10px; margin-bottom: 10px">
                                ...
                                <tr>
                                    <th width="20%">Name</th>
                                    <th width="20%">Name Sender</th>
                                    <th width="20%">Date Sender</th>
                                ...
                                while ($rs = mysql_fetch_object($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a class="btn btn-success"  href="frm_adddetail.php?pa_id=<?php echo $rs->pa_id;?>">
                                                <i class="fas fa-pen"></i> Add
                                            </a>
                                            <a class="btn btn-warning"  href="frm_editdetail.php?pa_id=<?php echo $rs->pa_id;?>">
...
<script>
    ...
    function deleteLocation(fac_id) {
        Swal.fire({
            title: 'Are you sure?',
            ...
            if (result.isConfirmed) {
                window.location = "deletefac.php?fac_id="+fac_id;
            }
        })
    };
</script>
